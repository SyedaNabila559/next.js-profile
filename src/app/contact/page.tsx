...
export default function ContactMe() {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-pink-300 p-6">
        <h1 className="text-3xl font-bold text-black mb-8">Contact Me</h1>
        ...
        <form
          ...
          method="post"
          encType="text/plain"
          className="w-full max-w-md bg-pink-200 p-8 rounded-lg border border-black"
        >
          <label className="block text-black text-sm font-bold mb-2">Your Email:</label>
          <input
            type="email"
            name="email"
          ...
          <textarea
            ...
            className="w-full p-3 mb-6 border border-black rounded focus:outline-none"
            required
          />
